...
void UCharacterAnimationComponent::SetAnimationStance(
    ECharacterAnimationStance NewStance
)
{
    AnimationStance = NewStance;
}

void UCharacterAnimationComponent::ResetAnimationStance()
{
