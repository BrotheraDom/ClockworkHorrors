...
UCLASS()
class CLOCKWORKHORRORS_API UCharacterAnimInstance
...
protected:
	...
	UPROPERTY(
		BlueprintReadOnly,
		Category = "Character Animation|State"
	)
	...
	UPROPERTY(
		BlueprintReadOnly,
		Category = "Character Animation|Data"
	)
	...
	//
	// These are exposed directly so Sequence Player nodes
	// can use them as dynamic assets.
	// =========================================================

	UPROPERTY(
		BlueprintReadOnly,
		Category = "Character Animation|Locomotion"
	)
...
private:
	...
	UPROPERTY(Transient)
	TObjectPtr<UCharacterAnimationComponent>
		AnimationComponent;
};